...
const Ability: React.FC<Props> = ({ ability: { AbilityName, Description } }) => {
    ...
    return (
        <>
            <Head>
                <title>{AbilityName} Ability - Pokemon Renegade Platinum</title>
                <meta name="description" content={`Details and info on ${AbilityName} and all pokemon with the ability in Pokemon Renegade Platinum.`}></meta>
            </Head>
            <Layout>
