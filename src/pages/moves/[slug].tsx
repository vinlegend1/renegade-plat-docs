...
const Move: React.FC<Props> = ({ move }) => {
    ...
    return (
        <>
            <Head>
                <title>{move.Name} - Pokemon Renegade Platinum</title>
                <meta name="description" content={`Details and info on ${move.Name} including its type, power, accuracy, and all pokemon that can learn it in Pokemon Renegade Platinum.`}></meta>
            </Head>
            <Layout>
